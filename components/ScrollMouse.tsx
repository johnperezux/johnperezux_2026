export const ScrollMouse = ({className}: {className?: string}) => (
  <svg className={className} width="26" height="86" viewBox="0 0 26 86" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13 0C16.4478 0 19.7544 1.36964 22.1924 3.80761C24.6304 6.24558 26 9.55219 26 13V31C26 34.4478 24.6304 37.7544 22.1924 40.1924C19.7544 42.6304 16.4478 44 13 44C9.55219 44 6.24558 42.6304 3.80761 40.1924C1.36964 37.7544 0 34.4478 0 31L0 13C0 9.55219 1.36964 6.24558 3.80761 3.80761C6.24558 1.36964 9.55219 0 13 0Z" fill="var(--accent-two)"/>
    <path d="M13 40C8.03738 40 4 35.9626 4 31V13C4 8.03738 8.03738 4 13 4C17.9626 4 22 8.03738 22 13V31C22 35.9626 17.9626 40 13 40Z" fill="var(--accent-two)"/>
